	...
	async function sendMessage(event: SubmitEvent) {
		...
		fetch('/api/sendContactForm', {
			...
			body: JSON.stringify({
				...
				lineId: event.target.lineId.value,
	...
	<div class="max-w-7xl mx-auto">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-16">
			<div class=" p-8 rounded-2xl">
				<div class="flex items-center gap-6 mb-6">
					<div class="relative inline-flex">
						<div class="w-5 h-5 bg-green-500 rounded-full absolute"></div>
						<div class="w-5 h-5 bg-green-500 animate-ping rounded-full"></div>
					</div>
					<div>
						<h2 class="text-2xl font-bold">{m.get_in_touch()}</h2>
				...
				<a
					href="https://line.me/ti/p/thehillsresort"
					class="bg-[#00B900] p-4 rounded-lg flex text-white gap-4 items-center text-xl justify-center"
				>
					<svg
			...
			<div class="space-y-8">
						...
						<div class="flex items-start">
							...
							<div>
								...
								<a
									...
									class="text-[#fcb100] underline"
								>
									96 หมู่ 1 บ.เสลี่ยงแห้ง 3 Nong Mae Na, Khao Kho District, Phetchabun 67270
								</a>
							</div>
						</div>
						<div class="flex items-start">
				...
				<div class="bg-black/5 p-8 rounded-2xl">
					<h3 class="text-xl font-bold mb-4">Follow Us</h3>
					<div class="flex space-x-4">
						<a href="#" class="text-[#fcb100] hover:text-[#fcb100]/80 transition-colors">
